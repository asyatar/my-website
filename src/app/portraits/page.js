export default function about() {
  return (
    ...
    <h1 className="name">portrait drawings</h1>
    <span style={{ 
      ...
      <table className="table-horizontal-only">
        <tbody>
          <tr style={{ borderBottom: 'none' }}>
            ...
            <td style={{ padding: '0' }}>
              <img src="portrait1.png" style={{marginTop: "30px", marginBottom:"30px"}}/>
              <img src="portrait2.png" style={{marginBottom:"30px"}}/>
              <img src="portrait3.png"/>
            </td>
          </tr>
        </tbody>
      </table>
